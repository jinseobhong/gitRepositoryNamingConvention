...
1. 저장소 이름 규칙(Naming convention)은 카멜(Camel) 표기법을 사용합니다.
2. 저장소 이름 규칙(Naming convention)은 Project progress-Proejct name-Project role-Development environment의 형태로 제안합니다.
